#!/usr/bin/env python3
"""
Malicious category implementation for domain blocklist.
"""
...
class MaliciousCategory(BaseCategory):
    """Malicious domain blocklist category"""
    
    def __init__(self):
        super().__init__("malicious")
    
    def get_readme_content(self, stats):
        """Generate README content for malicious category"""
        ...
        readme_content = f"""# 🚫 {stats.get('name', 'Malicious')} Domain Blocklist
