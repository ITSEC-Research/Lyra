...
- **Last Updated**: 2025-09-23 12:11:06 WIB
- **Total Categories**: 4
- **Total Domains**: 3,753,232
- **Total Sources**: 24
- **Active Sources**: 24
...
|----------|---------|---------|--------|------|
| Gambling | 1,691,111 | 6/6 | ✅ Active | [`gambling.txt`](blocklist/gambling.txt) |
| Suspicious | 302,005 | 7/7 | ✅ Active | [`suspicious.txt`](blocklist/suspicious.txt) |
| Malicious | 1,004,276 | 7/7 | ✅ Active | [`malicious.txt`](blocklist/malicious.txt) |
| Adult | 755,840 | 4/4 | ✅ Active | [`adult.txt`](blocklist/adult.txt) |
